# Consuming Gloria Royal Invitation Design System in Expo apps

Read `artifacts/gloria-royal-invitation-ds/docs/AGENTS.md` first. React Native does
...
`artifacts/gloria-royal-invitation-ds/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/gloria-royal-invitation-ds/tokens";
...
```tsx
import { nativeTheme } from "@workspace/gloria-royal-invitation-ds/lib/native-theme";
import { useColors } from "@workspace/gloria-royal-invitation-ds/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/gloria-royal-invitation-ds/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/gloria-royal-invitation-ds/components/native/badge";
import { Button } from "@workspace/gloria-royal-invitation-ds/components/native/button";
import { Card } from "@workspace/gloria-royal-invitation-ds/components/native/card";
```
...
Import and render
`@workspace/gloria-royal-invitation-ds/components/native/button`, then run Expo
