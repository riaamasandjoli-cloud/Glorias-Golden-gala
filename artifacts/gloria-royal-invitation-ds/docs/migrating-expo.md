# Migrating Expo UI to Gloria Royal Invitation Design System

Read `artifacts/gloria-royal-invitation-ds/docs/AGENTS.md` and
`artifacts/gloria-royal-invitation-ds/docs/consuming-expo.md` first. Use this guide
...
- Rewrite color/theme imports to
  `@workspace/gloria-royal-invitation-ds/lib/native-theme` and
  `@workspace/gloria-royal-invitation-ds/hooks/use-colors`.
- Rewrite the root layout to use
  `@workspace/gloria-royal-invitation-ds/hooks/use-fonts` while preserving its
  SplashScreen gating.
...
and hook directly from `@workspace/gloria-royal-invitation-ds` and retains only
