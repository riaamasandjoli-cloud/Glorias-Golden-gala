# Consuming Gloria Royal Invitation Design System in web apps

Read `artifacts/gloria-royal-invitation-ds/docs/AGENTS.md` first. This guide covers
...
`artifacts/gloria-royal-invitation-ds/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/gloria-royal-invitation-ds/styles.css";
```
...
`node_modules/@workspace/gloria-royal-invitation-ds/src/components` to `content`.
...
```tsx
import { Button } from "@workspace/gloria-royal-invitation-ds/components/ui/button";
import { cn } from "@workspace/gloria-royal-invitation-ds/lib/utils";
import {
  toast,
  useToast,
} from "@workspace/gloria-royal-invitation-ds/hooks/use-toast";
```
...
`@workspace/gloria-royal-invitation-ds/components/ui/button`. Run the app's typecheck
