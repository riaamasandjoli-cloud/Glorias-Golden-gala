# Migrating web UI to Gloria Royal Invitation Design System

Read `artifacts/gloria-royal-invitation-ds/docs/AGENTS.md` and
`artifacts/gloria-royal-invitation-ds/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/gloria-royal-invitation-ds/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/gloria-royal-invitation-ds/lib/utils`
- `@/hooks/use-toast` → `@workspace/gloria-royal-invitation-ds/hooks/use-toast`
