...
export const DESIGN_SYSTEM = {
  title: "Gloria's Royal Invitation Design System",
  description:
    'A ceremonial visual language extracted from Gloria’s sixteenth birthday invitation.',
} as const;
    ...
    entries: [
      {
        id: 'content-voice',
        name: 'Voice and tone',
        description: 'Warm, composed, and intimate invitation copy.',
        Page: ContentPage,
      },
    ],
  },
    ...
    entries: [
      {
        ...
        description: 'Graceful reveal, hover, and scroll behaviors.',
        Page: MotionPage,
      },
    ],
  },
